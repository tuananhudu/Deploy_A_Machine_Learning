...
class ApartmentService():
    def __init__(self):
        self.path_model = r'C:\Test\Deploy_A_Machine_Learning\artifacts\randomForestForApartmentPrice.pkl'
        self.path_encoder = r'C:\Test\Deploy_A_Machine_Learning\artifacts\neighbourhood_encoder.pkl'
    ...
    def preprocess_input(self , request : ApartmentRequest) -> pd.DataFrame:
        ...
        return data_df
    def predict_price(self , request : ApartmentResponse)-> ApartmentResponse:
